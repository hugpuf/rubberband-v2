...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-normal tracking-tight text-[#1C1C1E]">Good afternoon</h1>
      ...
      <div className="border-t border-gray-100 pt-8">
        <h2 className="text-xl font-normal mb-6 text-[#1C1C1E] tracking-tight">Module Widgets</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="rounded-xl border border-dashed border-gray-200 p-8 text-center bg-white transition-all duration-300 hover:shadow-sm">
              <p className="text-[#636366] font-normal">Module Widget {i}</p>
